var legendsconstructor=function(){
  ...
  var legendsproperties={
    ...
    "piecedata":[
      ...
      {"name":"Harry Potter","power":"10","race":"Hogwarts student","abilities":"<i>Action</i>: Flying<br><i>Ability</i>: If Harry is adjacent to Ron and/or Hermione, reveal Harry and Ron and/or Hermione to give them +1 until the end of the turn. Use this ability only once per turn.<br><i>Innate</i>: +1 against snakes","side":"good","set":"harrypotter","image":"2.jpg"},
      {"name":"Professor McGonagall","power":"9","race":"Hogwarts teacher and member of the Order of the Phoenix","abilities":"<i>Death Curse</i>: All Hogwarts students get +1.","side":"good","set":"harrypotter","image":"4.jpg"},
      {"name":"Hagrid","power":"8","race":"Hogwarts teacher and member of the Order of the Phoenix","abilities":"<i>Innate</i>: +1 on forest spaces<br><i>Innate</i>: +1 against beasts","side":"good","set":"harrypotter","image":"39.jpg"},
      {"name":"Ron Weasley","power":"8","race":"Hogwarts student","abilities":"<i>Ability</i>: If Ron is adjacent to Harry and/or Hermione, reveal Ron and Harry and/or Hermione to give them +1 until the end of the turn. Use this ability only once per turn.","side":"good","set":"harrypotter","image":"75.jpg"},
      {"name":"Sirius Black","power":"8","race":"member of the Order of the Phoenix","abilities":"<i>Action</i>: Switching (with any non-human)<br><i>Innate</i>: +1 against dementors","side":"good","set":"harrypotter","image":"6.jpg"},
      {"name":"Hermione","power":"7","race":"Hogwarts student","abilities":"<i>Ability</i>: If Hermione is adjacent to Harry and/or Ron, reveal Hermione and Harry and/or Ron to give them +1 until the end of the turn. Use this ability only once per turn.<br><i>Innate</i>: +1 on town spaces<br><i>Innate</i>: Dispel magic","side":"good","set":"harrypotter","image":"214.jpg"},
      {"name":"Mad-eye Moody","power":"7","race":"member of the Order of the Phoenix","abilities":"<i>Action</i>: Vision","side":"good","set":"harrypotter","image":"43.jpg"},
      {"name":"Fawkes","power":"7","race":"phoenix","abilities":"<i>Action</i>: Flying<br><i>Action</i>: Reveal Fawkes (whilst on a mountain space) to move him to any empty mountain space.","side":"good","set":"harrypotter","image":"78.jpg"},
      {"name":"Buckbeak","power":"6","race":"hippogriff","abilities":"<i>Action</i>: Flying<br><i>Innate</i>: Berzerk","side":"good","set":"harrypotter","image":"13.jpg"},
      {"name":"Hogwarts Express","power":"6","race":"train","abilities":"<i>Action</i>: Reveal the Hogwarts Express and an adjacent Hogwarts student or teacher to give them quickness until the end of the turn.","side":"good","set":"harrypotter","image":"79.jpg"},
      {"name":"Remus Lupin","power":"6","race":"member of the Order of the Phoenix","abilities":"<i>Innate</i>: Berzerk<br><i>Ability</i>: Lupin may attack a piece under your control.<br><i>Innate</i>: +1 when attacking","side":"good","set":"harrypotter","image":"11.jpg"},
      {"name":"Charlie Weasley","power":"5","race":"dragon keeper","abilities":"<i>Innate</i>: +3 against dragons<br><i>Action</i>: Flying","side":"good","set":"harrypotter","image":"16.jpg"},
      {"name":"Rufus Scrimgeour","power":"5","race":"Minister of Magic","abilities":"<i>Action</i>: Surround","side":"good","set":"harrypotter","image":"216.jpg"},
      {"name":"Sword of Griffindor","power":"5","race":"sword","abilities":"<i>Ability</i>: Reveal the Sword of Griffindor and an adjacent piece to give the adjacent piece +1 until the end of the turn. Use this ability only once per turn.","side":"good","set":"harrypotter","image":"84.jpg"},
      {"name":"Kingsley Shacklebolt","power":"4","race":"member of the Order of the Phoenix","abilities":"<i>Death Curse</i>: All Death Eaters get -1.","side":"good","set":"harrypotter","image":"51.jpg"},
      {"name":"Firebolt","power":"4","race":"broomstick","abilities":"<i>Ability</i>: Reveal Firebolt and an adjacent piece to give the adjacent piece flying action until the end of the turn.","side":"good","set":"harrypotter","image":"86.jpg"},
      {"name":"Archer","power":"4","race":"centaur","abilities":"<i>Action</i>: Distance Strike","side":"good","set":"harrypotter","image":"87.jpg"},
      {"name":"Fluffy","power":"3","race":"three-headed dog","abilities":"<i>Innate</i>: Berzerk","side":"good","set":"harrypotter","image":"218.jpg"},
      {"name":"Unicorn","power":"3","race":"unicorn","abilities":"<i>Ability</i>: After Unicorn successfully attacks, gain control of any adjacent piece.","side":"good","set":"harrypotter","image":"90.jpg"},
      {"name":"Professor Flitwick","power":"3","race":"Hogwarts teacher","abilities":"<i>Innate</i>: Dispel magic<br><i>Action</i>: Quickness","side":"good","set":"harrypotter","image":"20.jpg"},
      {"name":"Madam Pomfrey","power":"2","race":"nurse","abilities":"<i>Ability</i>: Reveal this piece when an attack happens.  If both pieces involved in the attack have the same current strength, instead of both pieces being destroyed, neither is destroyed and the attacking piece moves onto the square it last occupied.<br><i>Innate</i>: If Madam Pomfrey has been revealed, she must use her ability whenever possible.","side":"good","set":"harrypotter","image":"58.jpg"},
      {"name":"Dobby","power":"2","race":"house-elf","abilities":"<i>Innate</i>: If Dobby attacks or is attacked by a piece which destroyed Harry Potter, the piece is destroyed.<br><i>Innate</i>: -1.5 when attacking","side":"good","set":"harrypotter","image":"219.jpg"},
      {"name":"Neville Longbottom","power":"2","race":"Hogwarts student","abilities":"<i>Death Curse</i>: All members of the Order of the Phoenix get +1.","side":"good","set":"harrypotter","image":"24.jpg"},
      {"name":"Priori Incantem","power":"1","race":"spell","abilities":"<i>Innate</i>: If Priori Incantem attacks or is attacked by Voldemort, Voldemort is destroyed.","side":"good","set":"harrypotter","image":"220.jpg"},
      {"name":"Wingardium Leviosa","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If Wingardium Leviosa is attacked, destroy it and its attacker.","side":"good","set":"harrypotter","image":"98.jpg"},
      {"name":"Impedimenta","power":"*","race":"magic","abilities":"<i>Stationary</i>: Cannot move<br><i>Magic</i>: If Impedimenta is attacked, destroy it. Good gets an extra turn after the next good turn.","side":"good","set":"harrypotter","image":"62.jpg"},
      {"name":"Patronus","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If Patronus is attacked, destroy it and its attacker. If the attacker is a dementor, you may bring back a destroyed beast or non-human magical creature on any emtpy space. If the attacker is not a dementor, you may reveal any two pieces.","side":"good","set":"harrypotter","image":"63.jpg"},
      {"name":"Protego","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If Protego is attacked, destroy it and its attacker.<br><i>Death Curse</i>: All humans get +1","side":"good","set":"harrypotter","image":"30.jpg"},
      ...
      {"name":"Draco Malfoy","power":"7","race":"Hogwarts student and Death Eater","abilities":"<i>Ability</i>: Reveal Draco Malfoy to give -1 to an adjacent Hogwarts student until the end of the turn. Use this ability only once per turn.<br><i>Innate</i>: Dispel magic<br><i>Innate</i>: -1 against adult wizards and witches","side":"evil","set":"harrypotter","image":"110.jpg"},
      {"name":"Basilisk","power":"7","race":"snake","abilities":"<i>Action</i>: Reveal and destroy the Basilisk to destroy all adjacent pieces.","side":"evil","set":"harrypotter","image":"111.jpg"},
      {"name":"Hungarian Horntail","power":"6","race":"dragon","abilities":"<i>Action</i>: Flying<br><i>Ability</i>: Reveal the Hungarian Horntail to give -0.5 to a piece 2 spaces away until the end of the turn. Use this ability only once per turn.","side":"evil","set":"harrypotter","image":"115.jpg"},
      {"name":"Bellatrix Lestrange","power":"6","race":"Death Eater","abilities":"<i>Ability</i>: Crucio. When Bellatrix Lestrange attacks or is attacked, you may ignore the effects of any innate powers or abilities of the piece which is attacking or being attacked.<br><i>Action</i>: Quickness","side":"evil","set":"harrypotter","image":"147.jpg"},
      {"name":"Fenrir Greyback","power":"6","race":"werewolf","abilities":"<i>Action</i>: Slashing<br><i>Action</i>: Quickness","side":"evil","set":"harrypotter","image":"149.jpg"},
      {"name":"Chimera","power":"5","race":"chimera","abilities":"<i>Innate</i>: +1 on mountain spaces<br><i>Action</i>: Flying","side":"evil","set":"harrypotter","image":"185.jpg"},
      {"name":"Hand of Glory","power":"5","race":"magical artifact","abilities":"<i>Ability</i>: Reveal and destroy the Hand of Glory to give an adjacent piece +1 until the end of the turn. Reveal the adjacent piece affected.","side":"evil","set":"harrypotter","image":"184.jpg"},
      {"name":"McNair","power":"5","race":"Death Eater and executioner","abilities":"<i>Action</i>: Vision<br><i>Innate</i>: +1 against beasts and non-human magical creatures","side":"evil","set":"harrypotter","image":"116.jpg"},
      {"name":"Wormtail","power":"4","race":"Death Eater","abilities":"<i>Ability</i>: After Wormtail makes a successful attack, you may destroy him to place a destroyed piece on the space Wormtail occupied.","side":"evil","set":"harrypotter","image":"153.jpg"},
      {"name":"Mountain troll","power":"4","race":"troll","abilities":"<i>Innate</i>: +2 on mountain spaces.","side":"evil","set":"harrypotter","image":"119.jpg"},
      {"name":"Rogue bludger","power":"4","race":"bludger","abilities":"<i>Action</i>: Distance Strike","side":"evil","set":"harrypotter","image":"189.jpg"},
      {"name":"Crabbe","power":"3","race":"Hogwarts student and Death Eater","abilities":"<i>Death Curse</i>: All Death Eaters gain dispel magic.","side":"evil","set":"harrypotter","image":"122.jpg"},
      {"name":"Goyle","power":"3","race":"Hogwarts student and Death Eater","abilities":"<i>Death curse</i>: All good pieces with dispel magic lose dispel magic.","side":"evil","set":"harrypotter","image":"124.jpg"},
      {"name":"Narcissa Malfoy","power":"3","race":"Death Eater","abilities":"<i>Death Curse</i>: All Death Eaters get +1.","side":"evil","set":"harrypotter","image":"156.jpg"},
      {"name":"Grim","power":"2","race":"dog and death omen","abilities":"<i>Ability</i>: Reveal the Grim to give -1 to an adjacent non-member of the Order of the Phoenix human until the end of the turn. Use this ability only once per turn.","side":"evil","set":"harrypotter","image":"126.jpg"},
      {"name":"Serpent","power":"2","race":"snake","abilities":"<i>Action</i>: Charging<br><i>Action</i>: Quickness<br><i>Innate</i>: +1 on forest spaces","side":"evil","set":"harrypotter","image":"195.jpg"},
      {"name":"Avery","power":"2","race":"Death Eater","abilities":"<i>Innate</i>: Dispel magic<br><i>Innate</i>: +1 on marsh spaces","side":"evil","set":"harrypotter","image":"125.jpg"},
      {"name":"Dursleys","power":"1","race":"muggles","abilities":"<i>Innate</i>: If the Dursleys attack or are attacked by Harry Potter, Harry Potter is destroyed.","side":"evil","set":"harrypotter","image":"128.jpg"},
      {"name":"Horcrux","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If this Horcrux is attacked, destroy it.<br><i>Action</i>: If Voldemort has been destroyed, reveal and destroy this Horcrux to place him on the space this Horcrux occupied.","side":"evil","set":"harrypotter","image":"202.jpg"},
      {"name":"Horcrux","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If this Horcrux is attacked, destroy it.<br><i>Action</i>: If Voldemort has been destroyed, reveal and destroy this Horcrux to place him on the space this Horcrux occupied.","side":"evil","set":"harrypotter","image":"134.jpg"},
      {"name":"Horcrux","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If this Horcrux is attacked, destroy it.<br><i>Action</i>: If Voldemort has been destroyed, reveal and destroy this Horcrux to place him on the space this Horcrux occupied.","side":"evil","set":"harrypotter","image":"133.jpg"},
      {"name":"Horcrux","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If this Horcrux is attacked, destroy it.<br><i>Action</i>: If Voldemort has been destroyed, reveal and destroy this Horcrux to place him on the space this Horcrux occupied.","side":"evil","set":"harrypotter","image":"132.jpg"},
      {"name":"Avada Kedavra","power":"*","race":"magic","abilities":"<i>Innate</i>: Cannot attack<br><i>Magic</i>: If Avada Kedavra is attacked, destroy it and its attacker.","side":"evil","set":"harrypotter","image":"130.jpg"},
      {"name":"Riddle House","power":"C","race":"castle","abilities":"<i>Stationary</i>: Cannot move<br><i>Ability</i>: Reveal the Riddle House and an adjacent Death Eater to give the adjacent Death Eater +1 until the end of the turn. Use this ability only once per turn.","side":"evil","set":"harrypotter","image":"136.jpg"}
    ],
